...
const handlers = {
  ...
  'repo.markMemoriesHelpful': (args) => self.Dumly.repo.markMemoriesHelpful(args.ids),
  'repo.markMemoriesUnhelpful': (args) => self.Dumly.repo.markMemoriesUnhelpful(args.ids),
  ...
  'repo.getRecentAcceptedMemories': (args) => self.Dumly.repo.getRecentAcceptedMemories(args),
  'repo.getAcceptedMemoriesByAuthor': (args) => self.Dumly.repo.getAcceptedMemoriesByAuthor(args),
  'repo.getPinnedAcceptedMemories': (args) => self.Dumly.repo.getPinnedAcceptedMemories(args),
  'repo.getAcceptedMemoriesByTopicTags': (args) => self.Dumly.repo.getAcceptedMemoriesByTopicTags(args),
  'repo.getRecentEditedAcceptedMemories': (args) => self.Dumly.repo.getRecentEditedAcceptedMemories(args),
  'repo.getHighHelpfulnessMemories': (args) => self.Dumly.repo.getHighHelpfulnessMemories(args),
  'repo.getRecentNegativeMemories': (args) => self.Dumly.repo.getRecentNegativeMemories(args),
  'repo.getSessionCandidates': (args) => self.Dumly.repo.getSessionCandidates(args),
  'repo.listAcceptedPage': (args) => self.Dumly.repo.listAcceptedPage(args),
  'repo.listNegativePage': (args) => self.Dumly.repo.listNegativePage(args),
