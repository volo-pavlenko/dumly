...
(function () {
  ...
  function call(action, args) {
    return new Promise((resolve, reject) => {
      if (!chrome?.runtime?.id) {
        reject(new Error('Extension reloaded — refresh this X tab to continue.'));
        return;
      }
      try {
  ...
  window.Dumly.repo = {
    ...
    markMemoriesHelpful: (ids) => call('repo.markMemoriesHelpful', { ids }),
    markMemoriesUnhelpful: (ids) => call('repo.markMemoriesUnhelpful', { ids }),
    ...
    getRecentAcceptedMemories: (args) => call('repo.getRecentAcceptedMemories', args),
    getAcceptedMemoriesByAuthor: (args) => call('repo.getAcceptedMemoriesByAuthor', args),
    getPinnedAcceptedMemories: (args) => call('repo.getPinnedAcceptedMemories', args),
    getAcceptedMemoriesByTopicTags: (args) => call('repo.getAcceptedMemoriesByTopicTags', args),
    getRecentEditedAcceptedMemories: (args) => call('repo.getRecentEditedAcceptedMemories', args),
    getHighHelpfulnessMemories: (args) => call('repo.getHighHelpfulnessMemories', args),
    getRecentNegativeMemories: (args) => call('repo.getRecentNegativeMemories', args),
    getSessionCandidates: (args) => call('repo.getSessionCandidates', args),
    listAcceptedPage: (args) => call('repo.listAcceptedPage', args),
    listNegativePage: (args) => call('repo.listNegativePage', args),
